...
Our design follows a naming scheme, where each table is named after the real domain object it represents, with junction tables following the structure<table1><table2><optional own name>.
...
Song (id, title, artist, album, coverURI, rentPrice, …) or
Movie (id, title, director, coverURI, rentPrice, …)
...
\subsection{Other potential section}
