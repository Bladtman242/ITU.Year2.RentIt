...
Our datamodel supports all the workflows presented in our use cases, and it does so by abstracting over the database design and relying on object oriented container classes, which can be retrieved by a few calls to our database access layer. An example use of the back-end is shown here in the context of the following use case from Appendix ~\ref{app:usecases}.
