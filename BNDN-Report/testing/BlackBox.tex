...
{\begin{tabular}{ | p{2cm} | p{3cm} | p{4cm} | p{4cm} | }
	...
	\hline
	11 & Valid input data & The account changes are made and the user is informed about this & The account changes are made and the user is informed about this \\
	\hline
...
{\begin{tabular}{ | p{2cm} | p{3cm} | p{4cm} | p{4cm} | }
	...
	Requirement & Input & Expected Output & Actual Output \\
	\hline
	25 & Run all the above tests with a manager account instead of a regular user & Every test is passed & Every test is passed \\
	\hline
	26 & A valid file is uploaded and the property fields are filled out & The artifact is created, and the manager is redirected to the artifact's page & The artifact is created, and the manager is redirected to the artifact's page \\
	\hline
	...
	\hline
	28 & The manager clicks the "Delete" button on an artifact & The artifact is deleted & The artifact is deleted \\
	\hline
\end{tabular}}}