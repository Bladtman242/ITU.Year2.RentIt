...
\label{chap:Empiri}
In this part we will describe the methods from Cadle \& Yeates\cite{caye} used in the project, how we used them, and any issues we may have experienced with them.
...
\input{./Appendices/networkdiag}
\input{./Appendices/milestones}
\input{./Appendices/workbreakdown}
\input{./Appendices/Burndown}
